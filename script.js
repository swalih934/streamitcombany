menu=[
    ...
    {
      "id": 3,
      "title": "Mens Cotton Jacket and  no 234",
      "price": 55.99,
    ...
    {
      "id": 11,
      "title": "Silicon Power 256GB SSD 3D NAND A55 SLC Cache P",
      "price": 109,
    ...
    {
      "id": 15,
      "title": "BIYLACLESEN Women's 3-in-1 Snowboard Jacket Winter and summer",
      "price": 56.99,
    ...
    {
      "id": 18,
      "title": "MBJ Women's Solid Short Sleeve Boat Neck V  boat ",
      "price": 9.85,
...
<a href="#" class="fas fa-eye"></a>
        ...
        <div class="price">$${item.newPrice}<span>$${item.prevPrice}</span></div>
      </div>
  `});
  document.querySelector('#root').innerHTML=a
//   ab.innerHTML=a
...
menu.forEach(item=>
    {b+=`
      ...
      document.querySelector('#menuu').innerHTML=b
